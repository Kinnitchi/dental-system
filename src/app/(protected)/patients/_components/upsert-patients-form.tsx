...
import { upsertPatient } from "@/actions/upsert-patient/actions";
...
interface UpsertPatientsFormProps {
  patient?: typeof patientsTable.$inferSelect;
  onSuccess?: () => void;
}

const UpsertPatientsForm = ({ patient, onSuccess }: UpsertPatientsFormProps) => {
  ...
  const upsertPatientAction = useAction(upsertPatient, {
    ...
    onError: () => {
      toast.error(patient ? "Erro ao atualizar paciente." : "Erro ao adicionar paciente.");
    },
  });
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="email" placeholder="Digite o e-mail do paciente" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
